...
-- Чеки та продажі (для SQL-запитів Дар'ї та Артема; перезалити БД: docker compose down -v)
INSERT INTO "Check" (check_number, id_employee, card_number, print_date, sum_total, vat) VALUES
('C20260001', 'C001', '1234567890123', '2026-06-01 10:30:00', 566.9900, 113.3980),
('C20260002', 'C001', NULL, '2026-06-02 14:15:00', 69.5900, 13.9180);

INSERT INTO sale (UPC, check_number, product_number, selling_price) VALUES
-- Чек 1: енергетики (категорія 1) — для запитів Дар'ї Q1 та Артема Q1
('100000000001', 'C20260001', 5, 52.00),
('100000000002', 'C20260001', 3, 56.55),
('100000000004', 'C20260001', 2, 68.67),
-- Чек 2: усі овочі (категорія 5) — для запиту Дар'ї Q2
('500000000001', 'C20260002', 1, 1.90),
('500000000002', 'C20260002', 1, 17.90),
('500000000003', 'C20260002', 1, 8.90),
('500000000004', 'C20260002', 1, 7.00),
('500000000005', 'C20260002', 1, 12.00),
('500000000006', 'C20260002', 1, 15.90),
('500000000007', 'C20260002', 1, 5.99);
